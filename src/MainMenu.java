	...
	public static void main(String[] args) {
		{
			...
			System.out.println("press 3: to Report:View Statistics of Report ");
			System.out.println("press 4: to Report:To view All Invoices");
			System.out.println("press 5: to Search (1)Invoice");
			System.out.println("press 6: to Program Statistics");
			...
			case 4:
				System.out.println("View Report Statistics");
				sh.reportAllItems();
				break;
			case 5:
